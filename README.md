...
- channel: channel on the WDH, including project (e.g., awaken/sa1.lidar.z03.c0)
- sdate: start date (e.g., 20230801000000)
- edate: end date (e.g., 20230801010000)
- ext: file category (e.g., user5)
- ftype: file type (e.g., nc)
